    ...
    <div className={`survey-wrapper ${submitted ? "submitted" : ""}`}>
      ...
      {submitted && !showForm && (
        <div className="results-container">
          <h2 className="results-title">Recommendation Summary</h2>
          <div className="results-section">
            <h3>🔝 Top Picks</h3>
            <ul>
              {recommendations.topPicks &&
              Object.keys(recommendations.topPicks).length > 0 ? (
                <ul>
                  {Object.entries(recommendations.topPicks).map(
                    ([category, tech], index) => (
                      <li key={index}>
            ...
            <h3>📊 Categorized Recommendations</h3>
            {Object.entries(recommendations.categorized).length > 0 ? (
              Object.entries(recommendations.categorized).map(
                ([category, tools]) => (
                  <div key={category}>
                    <h4>{category}</h4>
                    <ul>
              ...
              <p>No categorized suggestions available.</p>
            )}
          </div>
        </div>
      )}
